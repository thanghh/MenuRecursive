...
public class ParentChildMenuViewHolder extends ParentViewHolder {
    ...
    public ParentChildMenuViewHolder(@NonNull View itemView) {
        super(itemView);
        mRecipeTextView = (TextView) itemView.findViewById(R.id.recipe_textview);
        mArrowExpandImageView = (ImageView) itemView.findViewById(R.id.arrow_expand_imageview);
    }

    public void bind(@NonNull ParentMenuChildExpand recipe) {
